...
```bash
TRANSITION=$(node "/home/tempa/Desktop/priv-project/.claude/get-shit-done/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "/home/tempa/Desktop/priv-project/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "/home/tempa/Desktop/priv-project/.claude/get-shit-done/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
