...
- Usage: Reference from command with `@/home/tempa/Desktop/priv-project/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/tempa/Desktop/priv-project/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/tempa/Desktop/priv-project/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
